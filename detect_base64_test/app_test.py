...
from utils import RandomColorGenerator

app = Flask(__name__)

# 定义一个全局变量
app.config['color_generator'] = RandomColorGenerator()
app.config['detector'] = PestDetector(color_generator=app.config['color_generator'])
