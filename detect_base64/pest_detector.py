...
from utils import non_max_suppression, letterbox, scale_boxes, RandomColorGenerator
...
class PestDetector():
    ...
    #
    # def draw_boxes(self, image, prediction, color='red', thickness=2, show_label=True):
    #     draw = ImageDraw.Draw(image)
    #     font = ImageFont.truetype(font='templates/simhei.ttf', size=12, encoding='utf-8')
    #     # font = ImageFont.load_default()
    #
    ...
    #             # print(type(label))
    #
    #             # text_size1 = font.getlength(label)  # Pillow 10以上的版本
    #             text_size = font.getsize(label)  # pip install Pillow==9.5 ,需要降级
    #
    #             # 设置标签背景
...
if __name__ == '__main__':
    ...
    image = Image.open('img/000003.jpeg')
    image_det, result = detector.predict(image, 'test.jpg')
    print(type(image_det))
    image_det.save('outputx/' + '000003.jpeg')
    print(result)
